...
$MailToAddress = "info@hazarton.com"; // your email address
$redirectURL = "hvala.html"; // the URL of the thank you page.
$MailSubject = "[Poruka sa internet stranice]"; // the subject of the email
