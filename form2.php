...
$MailToAddress = "info@buonarte.com"; // your email address
$redirectURL = "http://www.hazarton.com/hvala.htm"; // the URL of the thank you page.
$MailSubject = "[Poruka sa Internet kontakt stranice]"; // the subject of the email
